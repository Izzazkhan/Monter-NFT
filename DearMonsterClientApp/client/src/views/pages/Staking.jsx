                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body staking">
                                                ...
                                                <div class="mb-md-5 mb-4 stake-Form w-100  position-relative">
                                                    <input type="number" class="form-control filterCheckBtn" id="exampleFormControlInput1" placeholder="Stake Amount in BUSD" value="" />
                                                ...
                                                <div className='d-flex align-items-center mb-5'>
                                                    <input type="number" class="form-control p-3 filterCheckBtn me-2" id="exampleFormControlInput1" placeholder="Stake Amount in BUSD" value="" />
